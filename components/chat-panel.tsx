...
export function ChatPanel({
  ...
  return (
    ...
    <div>
      <div className="border-b text-white flex flex-col gap-8 pb-12">
        <p className="">Write a few sentences about yourself.</p>
        <div className="">
          <PromptForm
            complete={complete}
            input={input}
        ...
        <div className="col-span-full">
          ...
          {/*     <Icons.media className="mx-auto h-12 w-12" aria-hidden="true" /> */}
